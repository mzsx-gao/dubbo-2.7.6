...
public class DubboProtocol extends AbstractProtocol {
    ...
    public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
        ...
        // 1.demoGroup/com.alibaba.dubbo.demo.DemoService:1.0.1:20880
        // 2.org.apache.dubbo.demo.DemoService:20888
    ...
    private void openServer(URL url) {
        // 获取 host:port，并将其作为服务器实例的 key，用于标识当前的服务器实例,例如:192.168.151.2:20888
    ...
    private ProtocolServer createServer(URL url) {
        // url增加几个参数：channel.readonly.sent，heartbeat，codec
        ...
        if (str != null && str.length() > 0) {
            ...
            if (!supportedTypes.contains(str)) {
                // 检测当前 Dubbo 所支持的 Transporter 实现类名称列表中是否包含 client 所表示的 Transporter，若不包含，则抛出异常

...
public class RpcRegistryProtocolTest {
    ...
    public void serverRpc() throws IOException {
        ...
        // 代理工程
        ProxyFactory proxyFactory = proxyLoader.getAdaptiveExtension();
        ...
        //暴露服务
        Invoker<DemoService> serviceInvoker = proxyFactory.getInvoker(service, DemoService.class, newRegistryUrl);

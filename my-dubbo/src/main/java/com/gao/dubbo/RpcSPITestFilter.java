...
import com.gao.dubbo.filter.FilterB;
...
public class RpcSPITestFilter {
    ...
    public void clientInvoker() throws IOException {
        ...
        //@----直接调用方式
        Invocation invocation = new RpcInvocation("sayHello","com.enjoy.service.DemoService",new Class<?>[]{String.class},new Object[]{"invoke直接调用"});
        Result result2 =  referInvoker.invoke(invocation);
        System.out.println(result2.getValue());
    }

    private Invocation invocation = new RpcInvocation("sayHello","com.enjoy.service.DemoService",new Class<?>[]{String.class},new Object[]{"invoke调用"});
